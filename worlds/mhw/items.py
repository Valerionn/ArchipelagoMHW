...
item_name_groups = {
    ...
    "Rarity 1 Weapons": {name for name in weapons_by_rarity[0].values()},
    "Rarity 2 Weapons": {name for name in weapons_by_rarity[1].values()},
    "Rarity 3 Weapons": {name for name in weapons_by_rarity[2].values()},
    "Rarity 4 Weapons": {name for name in weapons_by_rarity[3].values()},
    "Rarity 5 Weapons": {name for name in weapons_by_rarity[4].values()},
    "Rarity 6 Weapons": {name for name in weapons_by_rarity[5].values()},
    "Rarity 7 Weapons": {name for name in weapons_by_rarity[6].values()},
    "Rarity 8 Weapons": {name for name in weapons_by_rarity[7].values()},
